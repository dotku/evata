    ...
    html: `
      <div style="max-width:600px;margin:0 auto;font-family:Arial,sans-serif;color:#333;">
        ...
        <div style="padding:32px;background:#fff;border:1px solid #e5e7eb;">
          ...
          <ul>
            <li><strong>Derma10 Professional Device</strong> — salon-grade treatments</li>
            <li><strong>Derma Home Device</strong> — at-home beauty solutions</li>
            <li><strong>Hyperloop Series</strong> — advanced scalp & skin care</li>
          </ul>
    ...
    html: `
      <div style="max-width:600px;margin:0 auto;font-family:Arial,sans-serif;color:#333;">
        ...
        <div style="padding:32px;background:#fff;border:1px solid #e5e7eb;">
          ...
          <p>Vita C brightening ampoules, deep repair creams, and professional-grade masks.</p>
          <h3 style="color:#059669;">💊 Wellness</h3>
          <p>Collagen jelly, probiotics, and bone & joint support formulas.</p>
          ...
          <div style="text-align:center;margin:24px 0;">
            <a href="https://unincore.us" style="background:#059669;color:white;padding:12px 24px;text-decoration:none;border-radius:8px;font-weight:bold;">Shop Now</a>
          </div>
          <p>Best regards,<br/><strong>Evata Team</strong><br/>info@unincore.us | 415-923-1212</p>
        </div>
        <div style="padding:16px;text-align:center;color:#9ca3af;font-size:12px;">
    ...
    html: `
      <div style="max-width:600px;margin:0 auto;font-family:Arial,sans-serif;color:#333;">
        ...
        <div style="padding:32px;background:#fff;border:1px solid #e5e7eb;">
          ...
          <ul>
            <li><strong>Miao Silver Phoenix Necklace</strong> — $460</li>
            <li><strong>Silver Filigree Bracelet</strong> — $280</li>
            <li><strong>Miao Embroidered Earrings</strong> — $95</li>
            <li><strong>Miao Silver Embroidered Jacket</strong> — $580</li>
            <li><strong>Guizhou Batik Silk Scarf</strong> — $168</li>
          </ul>
          <p>Each piece carries centuries of cultural heritage and is one-of-a-kind.</p>
          <div style="text-align:center;margin:24px 0;">
            <a href="https://evata.us/en#products" style="background:#b45309;color:white;padding:12px 24px;text-decoration:none;border-radius:8px;font-weight:bold;">View Collection</a>
          </div>
          <p>Best regards,<br/><strong>Evata Team</strong><br/>info@unincore.us | 415-923-1212</p>
        </div>
        <div style="padding:16px;text-align:center;color:#9ca3af;font-size:12px;">
